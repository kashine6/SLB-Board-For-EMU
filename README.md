...
The SLB is not only suitable for EMU, but can also provide additional channel expansion for systems such as BoxTurtle. The board itself includes built-in support for controlling N20 motors.
...
- **1 x Hall ADC interfaces** for PSF Sensor
- **1 x 5V Brushed DC motor drivers** with forward/reverse support, En pin, and sleep mode, support hardware PWM.
- **1 x Hardware SPI interfaces**
...
For detailed wiring information, please refer to the official EMU documentation:

https://github.com/DW-Tas/EMU/tree/main/docs/assembly_wiring/#solo-lane-board-slb-wiring-dimensions
...
<img src="Assets/1-6.png" width="100%"/>
...
Please refer to the official EMU documentation:

https://github.com/DW-Tas/EMU/blob/main/docs/software_setup/02-happy-hare-setup.md#configuring-the-emu-hardware
