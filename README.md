...
⚠️**Notice: ** Maximum rated current for SLB is 8A. If you plan to use PTC drying, only one unit can be operated at a time. For more than one unit, please use WAGO terminals to connect the power supply in parallel.
